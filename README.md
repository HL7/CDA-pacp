...
The `backups` directory contains the original word documents used to create the final PDFs published for this release and the Word files used to produce the pdfs.
